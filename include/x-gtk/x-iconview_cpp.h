...
#ifndef _ELISSO_XGTK_ICONVIEW_H
#define _ELISSO_XGTK_ICONVIEW_H
...
// using XGtkIconView = struct _XGtkIconView;
// using XGtkIconViewClass = struct _XGtkIconViewClass;
#endif /* DOXYGEN_SHOULD_SKIP_THIS */


#ifndef DOXYGEN_SHOULD_SKIP_THIS
namespace Gtk
{ class XIconView_Class; } // namespace Gtk
#endif //DOXYGEN_SHOULD_SKIP_THIS
   ...
   public Scrollable
{
  public:
#ifndef DOXYGEN_SHOULD_SKIP_THIS
  typedef XIconView CppObjectType;
  typedef XIconView_Class CppClassType;
  typedef XGtkIconView BaseObjectType;
  typedef XGtkIconViewClass BaseClassType;
#endif /* DOXYGEN_SHOULD_SKIP_THIS */

  XIconView(XIconView&& src) noexcept;
  XIconView& operator=(XIconView&& src) noexcept;

  // noncopyable
  XIconView(const XIconView&) = delete;
  XIconView& operator=(const XIconView&) = delete;

  ~XIconView() noexcept override;

#ifndef DOXYGEN_SHOULD_SKIP_THIS

private:
  friend class XIconView_Class;
  static CppClassType xiconview_class_;

protected:
  explicit XIconView(const Glib::ConstructParams& construct_params);
  explicit XIconView(XGtkIconView* castitem);
...
public:
  ...
  XGtkIconView*       gobj()       { return reinterpret_cast<XGtkIconView*>(gobject_); }

  ///Provides access to the underlying C GtkObject.
  const XGtkIconView* gobj() const { return reinterpret_cast<XGtkIconView*>(gobject_); }
...
public:
  ...
  XIconView();
    explicit XIconView(const Glib::RefPtr<TreeModel>& model);

    explicit XIconView(const Glib::RefPtr<CellArea>& cell_area);
...
namespace Glib
{
   ...
   */
  Gtk::XIconView* wrap(XGtkIconView* object, bool take_copy = false);
} //namespace Glib


#endif // _ELISSO_XGTK_ICONVIEW_H
